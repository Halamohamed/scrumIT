...
import com.scrum.webmvc.moduller.SubTask;
...
public class SubTaskController {
    ...
    public ResponseEntity<List<SubTask>> getSubTasks(){
        return restTemplate.exchange("http://DBManagement/subTask", HttpMethod.GET, null, new ParameterizedTypeReference<List<SubTask>>(){
        } );
    }
