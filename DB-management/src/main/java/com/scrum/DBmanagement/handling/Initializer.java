package com.scrum.DBmanagement.handling;
...
//add task 5
        ...
        Sprint sprint = Sprint.builder().plannedPeriod(14).tasks(tasks).team(teamrepo.findByName("Team1").get())
                ...
                .startSprint(LocalDate.of(2019, 3, 5)).demo(LocalDate.of(2019, 3, 21))
    ...
    private void addPersons() {
        Role role = Role.builder().name(RoleName.DEVELOPER).build();
        rolerepo.save(role);
