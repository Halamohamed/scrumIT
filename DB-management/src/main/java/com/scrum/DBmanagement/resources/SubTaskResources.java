...
import com.scrum.DBmanagement.repositories.SubTaskRepository;
...
public class SubTaskResources {
    ...
    private final Logger log = LoggerFactory.getLogger(SubTaskResources.class);

    @Autowired
    private SubTaskRepository repository;

    public SubTaskResources(SubTaskRepository repository) {
