...
import com.scrum.DBmanagement.repositories.SprintRepository;
...
public class SprintResources {
    private final Logger log = LoggerFactory.getLogger(SprintResources.class);

    @Autowired
    private SprintRepository repository;

    public SprintResources(SprintRepository repository) {
