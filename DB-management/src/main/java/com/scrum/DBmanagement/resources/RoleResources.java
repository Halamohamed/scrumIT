...
import com.scrum.DBmanagement.repositories.RoleRepository;
...
public class RoleResources {
    private final Logger log = LoggerFactory.getLogger(RoleResources.class);

    @Autowired
    private RoleRepository repository;

    public RoleResources(RoleRepository repository) {
